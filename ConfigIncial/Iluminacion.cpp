...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // --- 1. DIBUJAR TODOS LOS MODELOS ILUMINADOS ---
        lightingShader.Use();

        // Set light and view properties (se hace una sola vez para todos los modelos)
        ...
        // Set material properties (Nota: esto aplica un material genérico. La clase Model debería sobreescribirlo si el .mtl está bien)
        ...
        // Set view and projection matrices (se hace una sola vez para todos los modelos)
        ...
        sofa.Draw(lightingShader); // **LA CORRECCIÓN:** Usar lightingShader
        ...
        mesa.Draw(lightingShader); // **LA CORRECCIÓN:** Usar lightingShader
        ...
        maceta.Draw(lightingShader); // **LA CORRECCIÓN:** Usar lightingShader
        ...
        macetados.Draw(lightingShader); // **LA CORRECCIÓN:** Usar lightingShader

        // --- 2. DIBUJAR LA LÁMPARA (LA FUENTE DE LUZ) ---
        lampshader.Use();
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "view"), 1, GL_FALSE, glm::value_ptr(view));
        model = glm::mat4(1.0f); // Re-usamos la variable 'model'
        model = glm::translate(model, lightPos + movelightPos);
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));

        glBindVertexArray(VAO); // Ahora sí, vinculamos el VAO del cubo
        glDrawArrays(GL_TRIANGLES, 0, 36); // Y dibujamos el cubo
        glBindVertexArray(0);
