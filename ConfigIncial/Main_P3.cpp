...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 3 Proyecciones y transformaciones basicas    ALEJANDRO MARTINEZ JIMENEZ", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::translate(view, glm::vec3(-2.0f, -4.0f, -15.0f));
		...
		model = glm::rotate(model, glm::radians(189.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::rotate(model, glm::radians(262.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//BASE 5
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.4f, 2.0f, -2.0f));
		...
		//BASE 6
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.5f, 2.0f, -2.0f));
		...
		// BASE 7
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(6.5f, 2.0f, -2.0f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(5.0f, 4.0f, -2.0f));
